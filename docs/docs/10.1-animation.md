...
Previous versions of React didn't require these timeouts to be specified and relied on transitionend/animationend events to clean-up. This was found to be too unreliable and is no longer supported.
